...
const sections = [
  {
    ...
    photos: [
      { src: '/career-woman-blazer.png', label: 'Светлая студия' },
      { src: '/career-man-editorial.png', label: 'Editorial' },
      { src: '/career-woman-1.png', label: 'Корпоративный' },
      { src: '/studio-white-suit.png', label: 'Business chic' },
      { src: '/career-woman-2.png', label: 'Тёмный фон' },
      { src: '/review-avatar-1.png', label: 'Деловой портрет' },
  ...
  },
  {
    ...
    photos: [
      { src: '/dating-woman-mirror.png', label: 'В будуаре' },
      { src: '/studio-stool-woman.png', label: 'В студии' },
      { src: '/dating-woman-1.png', label: 'Огни города' },
      { src: '/studio-bw-man.png', label: 'Чёрно-белое' },
      { src: '/dating-man-1.png', label: 'Тёплый свет' },
      { src: '/studio-red-light.png', label: 'В прожекторе' },
      { src: '/social-woman-car.png', label: 'Стритстайл' },
      { src: '/dating-woman-3.png', label: 'Sensual' },
    ],
  },
  {
    id: 'social',
    ...
    photos: [
      { src: '/studio-red-light.png', label: 'Неон' },
      { src: '/studio-stool-woman.png', label: 'Fashion magazine' },
      { src: '/social-woman-1.png', label: 'Отдых у моря' },
      { src: '/studio-white-suit.png', label: 'Минимализм' },
      { src: '/social-woman-2.png', label: 'Летнее настроение' },
      { src: '/selfie-2.png', label: 'Зеркало' },
      { src: '/social-woman-3.png', label: 'В движении' },
      { src: '/career-man-editorial.png', label: 'Креатив' },
    ],
  },
];
