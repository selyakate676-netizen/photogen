...
const currentBasePhotoPacks: Omit<PhotoPack, 'pricing' | 'photoCount' | 'priceRub' | 'priceCrystals'>[] = [
  ...
  },
  {
    ...
    description: 'Два стильных осенних портрета в городе, у канала и кованой ограды',
    summary: 'Два связанных кадра городской осенней прогулки: сидячий hero-портрет и портрет у канала.',
    photos: 2,
    price: '99 ₽',
    category: 'lifestyle',
    categoryLabel: 'Lifestyle',
    ...
    features: ['2 профессиональных фото', 'Единый городской образ', 'Осенняя атмосфера', 'Сохранение внешности'],
    deliverables: ['Сидячий портрет у ограды', 'Городской портрет по колени'],
  },
  {
    id: 'misty-cabin',
    slug: 'misty-cabin',
