...
The release branch contains 69 HC/prompt definitions and 67 preview files. The difference is `SP-025`: four prompts exist, but only two previews have been visually accepted and stored. This is an explicit release blocker for the expanded four-frame form, not a reason to discard the pack or invent previews.
...
| `SP-025` | Осенний маршрут | 4 | 2 | B | partial: two-frame version accepted; HC-003/004 preview QA pending | `sp025-autumn-route-model-b-hc001.jpg` | `102b5c0` |
...
- Resolve `SP-025` truthfully: either add and visually approve previews for HC-003/004 or keep the approved two-frame contract consistently across metadata, prompts and pricing.
